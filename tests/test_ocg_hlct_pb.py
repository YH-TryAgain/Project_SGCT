...
from OCG_HLCT_PB import OCGHLCTPBAlgorithm, OCGPBPNode


class OCGHLCTPBAlgorithmTests(unittest.TestCase):
    ...
    def test_low_d_singletons_are_not_identified_without_epc_verify(self):
        ...
        algorithm = OCGHLCTPBAlgorithm(tags, signature_d_min=2, d_target_dense=2)
    ...
    def test_no_position_singleton_is_not_identified_without_epc_verify(self):
        tags = [Tag("0000")]
        algorithm = OCGHLCTPBAlgorithm(tags)
    ...
    def test_small_cluster_guard_avoids_small_batch_regression(self):
        ...
        guarded = OCGHLCTPBAlgorithm(tags, enable_small_cluster_guard=True)
        unguarded = OCGHLCTPBAlgorithm(tags)

        guarded_result = run_simulation_with_tags(tags, OCGHLCTPBAlgorithm, {"enable_small_cluster_guard": True})
    ...
    def test_default_pb_configuration_does_not_use_non_observable_small_cluster_guard(self):
        algorithm = OCGHLCTPBAlgorithm([Tag(format(i, "096b")) for i in range(32)])
    ...
    def test_algorithm_library_registers_sg_variant(self):
        ...
        self.assertIs(OCGHLCTPBAlgorithm, ALGORITHM_LIBRARY["SGCT"]["class"])
        self.assertIn("SGCT", ALGORITHM_LIBRARY)
        self.assertIs(OCGHLCTPBAlgorithm, ALGORITHM_LIBRARY["SGCT"]["class"])
    ...
    def test_queue_uses_deque_for_large_experiment_efficiency(self):
        algorithm = OCGHLCTPBAlgorithm([Tag("0000"), Tag("0001")])
    ...
    def test_adaptive_suffix_signature_skips_after_observed_dense_feedback(self):
        ...
        algorithm = OCGHLCTPBAlgorithm(tags)
        algorithm.current_node = OCGPBPNode(tags=tags, depth=1, last_idle_ratio=0.0)
    ...
    def test_adaptive_suffix_signature_triggers_when_suffix_window_resolves_singletons(self):
        ...
        result = run_simulation_with_tags(tags, OCGHLCTPBAlgorithm, {})
