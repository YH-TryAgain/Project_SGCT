...
class DRCTFinalPaperRulesTests(unittest.TestCase):
    ...
    def test_final_algorithm_exposes_compatible_alias(self):
        self.assertIs(DRCTAlgorithm, DRCTFinalAlgorithm)
    ...
    def test_reproduces_paper_sample_query_order_and_depth_updates(self):
        ...
        algorithm = DRCTFinalAlgorithm(tags, check_mode="epc_deterministic")
    ...
    def test_identical_check_fallback_answers_then_rest_id_detects_collision(self):
        ...
        algorithm = DRCTFinalAlgorithm(tags, check_bits=0)
    ...
    def test_default_mode_samples_random_check_values(self):
        ...
        algorithm = DRCTFinalAlgorithm(tags, check_seed=7)
